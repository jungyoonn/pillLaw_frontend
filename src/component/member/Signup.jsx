        ...
        <div className="mx-5 px-5 mt-4">
          <div className="mx-5 px-5">
            <div className="mx-5 px-5 mt-4">
              ...
              <div className="mx-4 px-4">
                ...
                <div className="d-grid px-5 mx-5 mt-3">
                  <Link to={"/"} className="btn btn-pilllaw mx-5 btn-block fw-bold text-white">
                    <FontAwesomeIcon icon={faEnvelope} className="fa-lg mx-2" />
                    이메일로 시작하기
                  </Link>
                </div>
                <div className="d-grid px-5 mx-5 mt-2">
                  <Link to={"/"} className="btn btn-kakao mx-5 btn-block fw-bold text-kakao p-1">
                    <img
            ...
            <div className="row text-center clearfix">
              <p className="col fw-bold fs-12 mx-3">
                <a className="text-decoration-none text-pilllaw" href="#">
                  개인정보 처리방침
                </a>
              </p>
              <p className="col fw-bold fs-12 mx-3">
